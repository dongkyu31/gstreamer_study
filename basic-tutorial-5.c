 ...
 * A minimum knowledge of GTK+ will help understand this tutorial.
 *
 * The main point is telling GStreamer to output the video to a window of our choice. 
 * The specific mechanism depends on the operating system (or rather, on the windowing system), 
 * but GStreamer provides a layer of abstraction for the sake of platform independence. 
 * This independence comes through the GstVideoOverlay interface, 
 * that allows the application to tell a video sink the handler of the window that should receive the rednering.
 *
 * 
 *
 *
